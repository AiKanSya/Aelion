...
flowchart TD
    ...
    C --> D["NODE.JS"]
    D --> E["FIORI EXTENSIONS FOR VSCODE"]
    E --> F["OPEN APPLICATION GENERATOR"]
```


## 🌺 HOST FILE

![](./assets/Capture%20d’écran%202026-02-09%20105016.png)
...
1. Ouvrez `Visual Studio Code`. Dans l'onglet de gauche, cliquez sur l'icône Extensions :
   ...
   ![](./assets/Capture%20d’écran%202026-05-20%20082228.png)

2. Recherchez `SAP Fiori Tools` et installer le.

   ![](./assets/Capture%20d’écran%202026-05-20%20082422.png)
...
![](./assets/Capture%20d’écran%202026-05-20%20083802.png)
