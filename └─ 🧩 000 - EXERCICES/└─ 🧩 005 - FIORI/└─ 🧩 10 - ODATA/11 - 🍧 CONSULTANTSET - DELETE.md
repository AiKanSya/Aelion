...
> Cours associé : [DELETE](<../../../└─ 🧩 005 - FIORI/└─ 🧩 10 - ODATA/11 - 🍧 CONSULTANTSET - DELETE.md>)
...
- [ ] Expliquer le rôle de **DELETE** dans le contexte présenté dans un exemple différent de celui du cours.
