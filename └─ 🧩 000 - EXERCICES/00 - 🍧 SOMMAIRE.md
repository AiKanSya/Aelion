...
Cette banque reprend la structure des cours. Elle contient un fichier d'exercices par chapitre et aucune correction.
...
1. Sélectionner les chapitres correspondant aux difficultés constatées.
2. Réaliser d'abord la restitution sans le cours.
3. Passer à la mise en pratique et au diagnostic.
4. Revenir au cours uniquement après identification du blocage.
5. Valider chaque chapitre avec une preuve vérifiable.
