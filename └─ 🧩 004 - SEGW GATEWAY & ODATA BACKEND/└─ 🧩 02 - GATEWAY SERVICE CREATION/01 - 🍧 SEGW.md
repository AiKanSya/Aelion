...
```mermaid
flowchart TD
    A["GATEWAY SERVICE BUILDER"]
    A --> B["GATEWAY SERVICE BUILDER - TRANSACTION SEGW"]
    B --> C["ODATA SERVICE"]
    C --> D["GATEWAY SERVICE"]
    D --> E["GATEWAY PROJECT"]
...
#### 💮 SERVICE IMPLÉMENTATION SECTION
...
> - Savoir utiliser **gateway service builder - transaction segw** dans le contexte présenté.
> - Savoir utiliser **odata service** dans le contexte présenté.
> - Savoir utiliser **gateway service** dans le contexte présenté.

<details>
<summary>🍧 Afficher l’auto-évaluation</summary>

- [ ] Je peux définir **GATEWAY SERVICE BUILDER** avec mes propres mots.
- [ ] Je peux expliquer **objectives** sans relire le chapitre.
- [ ] Je peux appliquer ou illustrer **gateway service builder - transaction segw** dans un exemple simple.
