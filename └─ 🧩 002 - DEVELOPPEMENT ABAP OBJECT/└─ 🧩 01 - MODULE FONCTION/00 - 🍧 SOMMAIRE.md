...
flowchart TD
    A["MODULE FONCTION"]
    A --> B["MODULE FONCTION & GROUPE FONCTION"]
    B --> C["CREATION SE37"]
    C --> D["INTERFACE"]
    D --> E["PASSAGE DE PARAMETRES"]
    E --> F["IMPLEMENTATION & DONNEES LOCALES"]
    F --> G["APPEL AVEC CALL FUNCTION"]
    G --> H["EXCEPTIONS"]
    H --> I["MESSAGES & RETOURS D'ERREURS"]
```
