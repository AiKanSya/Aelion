...
> - **Unit test class vs business class :** L'écriture de tests ABAP Unit est le moyen de fournir un logiciel de haute qualité, qui peut facilement évoluer au fil du temps sans introduire de régressions.

<details>
<summary>🍧 Afficher l’auto-évaluation</summary>

- [ ] Je peux définir **ABAP UNIT TEST CLASS** avec mes propres mots.
- [ ] Je peux expliquer **définition** sans relire le chapitre.
- [ ] Je peux appliquer ou illustrer **unit test class vs business class** dans un exemple simple.
