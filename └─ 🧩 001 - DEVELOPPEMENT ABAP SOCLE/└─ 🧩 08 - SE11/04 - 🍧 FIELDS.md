...
```mermaid
flowchart TD
    A["CHAMPS / ZONES / FIELDS"]
    A --> B["DEFINITION"]
    B --> C["CHAMPS DANS SE11 (STRUCTURES)"]
    C --> D["CHAMPS DANS SE16N (TABLES DE DONNÉES)"]
    D --> E["LIEN ENTRE CHAMP, ELEMENT DE DONNEES ET DOMAINE"]
...
- [ ] Je peux définir **CHAMPS / ZONES / FIELDS** avec mes propres mots.
- [ ] Je peux expliquer **definition** sans relire le chapitre.
- [ ] Je peux appliquer ou illustrer **champs dans se11 (structures)** dans un exemple simple.
