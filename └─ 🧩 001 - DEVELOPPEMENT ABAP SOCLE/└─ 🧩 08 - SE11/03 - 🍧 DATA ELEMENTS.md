...
```mermaid
flowchart TD
    A["ELEMENTS DE DONNEES"]
    A --> B["DEFINITION"]
    B --> C["RELATION ENTRE DOMAINE ET ELEMENT DE DONNEES"]
...
## 🌺 CRÉATION D’UN ELEMENT DE DONNEES
...
7. `Renseigner` le [DOMAINE](<./02 - 🍧 DOMAINS.md>) (exemple `ZCONSULTANT_ID`).
...
- [ ] Je peux définir **ELEMENTS DE DONNEES** avec mes propres mots.
- [ ] Je peux expliquer **definition** sans relire le chapitre.
- [ ] Je peux appliquer ou illustrer **relation entre domaine et element de donnees** dans un exemple simple.
