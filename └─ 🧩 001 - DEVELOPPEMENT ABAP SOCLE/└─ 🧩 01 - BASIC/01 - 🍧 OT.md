...
```mermaid
flowchart TD
    A["ORDRE DE TRANSPORT (OT) ET CREATION – SE10"]
    A --> B["DEFINITION"]
    B --> C["POURQUOI CREER UN OT ?"]
    C --> D["TYPES D'ORDRE DE TRANSPORT"]
    D --> E["CREATION D'UN OT A PARTIR DE LA TRANSACTION SE10"]
    E --> F["STRUCTURE D'UN OT"]
```
...
## 🌺 CRÉATION D'UN OT A PARTIR DE LA TRANSACTION SE10
...
- [ ] Je peux définir **ORDRE DE TRANSPORT (OT) ET CREATION – SE10** avec mes propres mots.
- [ ] Je peux expliquer **definition** sans relire le chapitre.
- [ ] Je peux appliquer ou illustrer **pourquoi creer un ot ?** dans un exemple simple.
